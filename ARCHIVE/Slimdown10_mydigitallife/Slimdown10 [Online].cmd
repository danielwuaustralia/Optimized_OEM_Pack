...
for /f "tokens=2 delims=: " %%a in ('start "" /b "DISM" /English /Online /Get-ProvisionedAppxPackages ^| find "PackageName"') do (
 set "RemoveUWPapp=%%a"
 ...
 if not "!RemoveUWPapp!"=="" (
  ...
  ECHO =====================================================================================================
  ECHO.
  "DISM" /English /Online /Remove-ProvisionedAppxPackage /PackageName:"!RemoveUWPapp!"
 )
)
...
reg load HKLM\TK_NTUSER "C:\Users\Default\ntuser.dat" >nul
...
setlocal EnableDelayedExpansion
for /f "tokens=1 delims=" %%a in ('dir /on /b "%ProgramFiles%\WindowsApps\Microsoft.*" 2^>nul') do (
 set "RemoveUWPapp=%%a"
 for %%u in (%IncludeUWPapps%) do (
  echo %%a | findstr /l /i /c:"%%u" >nul 2>&1 && set RemoveUWPapp=
 )
 ...
 if not "!RemoveUWPapp!"=="" (
  ...
  ECHO =====================================================================================================
  ECHO.
  "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait cmd /c "rd /s /q "%ProgramFiles%\WindowsApps\!RemoveUWPapp!""
 )
)

REM Clear the registry keys too
for /f "tokens=9 delims=\" %%a in ('reg query "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Applications" /k /f "Microsoft." 2^>nul ^| find /i "\Applications\Microsoft."') do (
 set "RemoveUWPapp=%%a"
 for %%u in (%IncludeUWPapps%) do (
  echo %%a | findstr /l /i /c:"%%u" >nul 2>&1 && set RemoveUWPapp=
 )
 ...
 if not "!RemoveUWPapp!"=="" (
  ...
  ECHO =====================================================================================================
  ECHO.
  reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Applications\!RemoveUWPapp!" /f >nul 2>&1
   for /f "tokens=1,4,5 delims=_" %%b in ('echo !RemoveUWPapp!') do (
    if "%%d"=="" (
     reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\%%b_%%c" /f >nul
     reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\%%b_%%c" /ve /f >nul 2>&1
     reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Staged\%%b_%%c" /f >nul 2>&1
     reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Config\%%b_%%c" /f >nul 2>&1
    )
    if not "%%d"=="" (
     reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\%%b_%%d" /f >nul
     reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Deprovisioned\%%b_%%d" /ve /f >nul 2>&1
     reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Staged\%%b_%%d" /f >nul 2>&1
     reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Config\%%b_%%d" /f >nul 2>&1
    )
   )
 )
)
...
reg add "HKLM\Software\Policies\Microsoft\Windows\DataCollection" /v "AllowUpdateComplianceProcessing" /t REG_DWORD /d 0 /f > NUL
reg add "HKLM\Software\Policies\Microsoft\Windows\DataCollection" /v "AllowWUfBCloudProcessing" /t REG_DWORD /d 0 /f > NUL
...
reg add "HKLM\Software\Policies\Microsoft\Windows\Troubleshooting\AllowRecommendations" /v "TroubleshootingAllowRecommendations" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{186f47ef-626c-4670-800a-4a30756babad}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{2698178D-FDAD-40AE-9D3C-1371703ADC5B}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{29689E29-2CE9-4751-B4FC-8EFF5066E3FD}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{29689E29-2CE9-4751-B4FC-8EFF5066E3FD}" /v "EnabledScenarioExecutionLevel" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{3af8b24a-c441-4fa4-8c5c-bed591bfa867}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{54077489-683b-4762-86c8-02cf87a33423}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{67144949-5132-4859-8036-a737b43825d8}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{8519d925-541e-4a2b-8b1e-8059d16082f2}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{86432a0b-3c7d-4ddf-a89c-172faa90485d}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
...
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{a7a5847a-7511-4e4e-90b1-45ad2a002f51}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{C295FBBA-FD47-46ac-8BEE-B1715EC634E5}" /v "DownloadToolsEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{C295FBBA-FD47-46ac-8BEE-B1715EC634E5}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{dc42ff48-e40d-4a60-8675-e71f7e64aa9a}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{dc42ff48-e40d-4a60-8675-e71f7e64aa9a}" /v "EnabledScenarioExecutionLevel" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{eb73b633-3f4e-4ba0-8f60-8f3c6f53168f}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{eb73b633-3f4e-4ba0-8f60-8f3c6f53168f}" /v "EnabledScenarioExecutionLevel" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{ecfb03d1-58ee-4cc7-a1b5-9bc6febcb915}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WDI\{ffc42108-4920-4acf-a4fc-8abdcc68ada4}" /v "ScenarioExecutionEnabled" /t REG_DWORD /d 0 /f >nul
...
echo fsutil behavior set disableLastAccess ^1 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
REM Unlimited max password age
echo net accounts /maxpwage:unlimited ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
REM Re-apply disable hibernation
echo powercfg /h off ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
REM Re-apply disable screen off timer
echo powercfg /SETACVALUEINDEX 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 7516b95f-f776-4464-8c53-06167f40cc99 3c0bc021-c8a8-4e07-a973-6b14cbcb2b7e 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETACVALUEINDEX 381b4222-f694-41f0-9685-ff5bb260df2e 7516b95f-f776-4464-8c53-06167f40cc99 3c0bc021-c8a8-4e07-a973-6b14cbcb2b7e 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
REM Re-apply disable USB AutoSuspend
echo powercfg /SETDCVALUEINDEX 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETACVALUEINDEX 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETDCVALUEINDEX 381b4222-f694-41f0-9685-ff5bb260df2e 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETACVALUEINDEX 381b4222-f694-41f0-9685-ff5bb260df2e 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
REM Re-apply disable idle Hard Disk auto power off
echo powercfg /SETDCVALUEINDEX 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 0012ee47-9041-4b5d-9b77-535fba8b1442 6738e2c4-e8a5-4a42-b16a-e040e769756e 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETACVALUEINDEX 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 0012ee47-9041-4b5d-9b77-535fba8b1442 6738e2c4-e8a5-4a42-b16a-e040e769756e 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETDCVALUEINDEX 381b4222-f694-41f0-9685-ff5bb260df2e 0012ee47-9041-4b5d-9b77-535fba8b1442 6738e2c4-e8a5-4a42-b16a-e040e769756e 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo powercfg /SETACVALUEINDEX 381b4222-f694-41f0-9685-ff5bb260df2e 0012ee47-9041-4b5d-9b77-535fba8b1442 6738e2c4-e8a5-4a42-b16a-e040e769756e 0 ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo set "PF=%%ProgramFiles%%">>"%windir%\Temp\SetupComplete.cmd"
echo if not "%%ProgramFiles(x86)%%"=="" set "PF=%%ProgramFiles(x86)%%">>"%windir%\Temp\SetupComplete.cmd"
echo set EdgeSetup=>>"%windir%\Temp\SetupComplete.cmd"
echo for /f "delims=" %%%%i in ('dir /b /s /a-d "%%PF%%\Microsoft\Edge\Application\setup.exe" 2^^^>nul') do (set "EdgeSetup=%%%%i")>>"%windir%\Temp\SetupComplete.cmd"
echo if "%%EdgeSetup%%"=="" goto skipEdgeUinstall>>"%windir%\Temp\SetupComplete.cmd"
echo start /w "" "%%EdgeSetup%%" --uninstall --system-level --force-uninstall>>"%windir%\Temp\SetupComplete.cmd"
echo reg delete "HKLM\SOFTWARE\Microsoft\EdgeUpdate" /f ^>nul 2^>^&^1>>"%windir%\Temp\SetupComplete.cmd"
echo :skipEdgeUinstall>>"%windir%\Temp\SetupComplete.cmd"
echo set PF=>>"%windir%\Temp\SetupComplete.cmd"
echo set EdgeSetup=>>"%windir%\Temp\SetupComplete.cmd"
if not "%RemoveSystemUWPappsAlsoFromDisk%"=="0" echo rd /s /q "%%windir%%\SystemApps\Microsoft.AAD.BrokerPlugin_cw5n1h2txyewy">>"%windir%\Temp\SetupComplete.cmd"
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait cmd /c "%windir%\Temp\SetupComplete.cmd" >nul 2>nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\SettingSync" /v "EnableBackupForWin8Apps" /t REG_DWORD /d "0" /f >nul
...
Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\TextInput" /v "AllowLanguageFeaturesUninstall" /t REG_DWORD /d 1 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\System" /v "EnableAppUriHandlers" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\StorageHealth" /v "AllowDiskHealthModelUpdates" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\PCHealth\HelpSvc" /v "MicrosoftKBSearch" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\Internet Connection Wizard" /v "ExitOnMSICW" /t REG_DWORD /d 1 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\Registration Wizard Control" /v "NoRegistration" /t REG_DWORD /d 1 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\SearchCompanion" /v "DisableContentFileUpdates" /t REG_DWORD /d 1 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows NT\Printers" /v "DisableHTTPPrinting" /t REG_DWORD /d 1 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows NT\Printers" /v "DisableWebPnPDownload" /t REG_DWORD /d 1 /f >nul
...
rem Reg add "HKLM\Software\Policies\Microsoft\EventViewer" /v "MicrosoftEventVwrDisableLinks" /t REG_DWORD /d 1 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\AppPrivacy" /v "LetAppsGetDiagnosticInfo" /t REG_DWORD /d 2 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\AppPrivacy" /v "LetAppsAccessGazeInput" /t REG_DWORD /d 2 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\AppPrivacy" /v "LetAppsAccessBackgroundSpatialPerception" /t REG_DWORD /d 2 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\AppPrivacy" /v "LetAppsAccessTasks" /t REG_DWORD /d 2 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Mail" /v "ManualLaunchAllowed" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\HomeGroup" /v "DisableHomeGroup" /t REG_DWORD /d 1 /f >nul
...
reg add "HKLM\Software\Policies\Microsoft\WindowsStore" /v "DisableOSUpgrade" /t REG_DWORD /d 1 /f >nul
...
reg add "HKLM\SYSTEM\ControlSet001\Services\swprv" /v "Start" /t REG_DWORD /d "3" /f >nul
...
reg add "HKLM\Software\Policies\Microsoft\Windows\StorageSense" /v "AllowStorageSenseTemporaryFilesCleanup" /t REG_DWORD /d 0 /f >nul
...
reg query "HKLM\Software\Microsoft\WindowsRuntime\ActivatableClassId" /e /k /f "Windows.Gaming.GameBar.PresenceServer.Internal.PresenceWriter" >nul 2>&1 && "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\WindowsRuntime\ActivatableClassId\Windows.Gaming.GameBar.PresenceServer.Internal.PresenceWriter" /v "ActivationType" /t REG_DWORD /d 0 /f >nul
reg query "HKLM\Software\Microsoft\WindowsRuntime\ActivatableClassId" /e /k /f "Windows.Gaming.GameBar.PresenceServer.Internal.PresenceWriter" >nul 2>&1 && "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\WindowsRuntime\ActivatableClassId\Windows.Gaming.GameBar.PresenceServer.Internal.PresenceWriter" /v "ActivationType" /t REG_DWORD /d 0 /f >nul

REM Remove Xbox Task
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Plain\{41F5FC9D-EE65-4CA4-A908-91B3587198E0}" /f >nul 2>&1
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tasks\{41F5FC9D-EE65-4CA4-A908-91B3587198E0}" /f >nul 2>&1
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tree\Microsoft\XblGameSave\XblGameSaveTask" /f >nul 2>&1
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "AllowCortanaInAAD" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "AllowCortanaInAADPathOOBE" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "NoLowDiskSpaceChecks" /t REG_DWORD /d 1 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\PassportForWork" /v "Enabled" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\PassportForWork" /v "DisablePostLogonProvisioning" /t REG_DWORD /d 0 /f >nul

REM Disable and Remove OneDrive
Reg add "HKLM\Software\Policies\Microsoft\OneDrive" /v "PreventNetworkTrafficPreUserSignIn" /t REG_DWORD /d 1 /f >nul
...
del /q /f "c:\Users\Default\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\OneDrive.lnk" >nul 2>&1
if exist "%WINDIR%\System32\OneDriveSetup.exe" "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait cmd /c "del /q /f "%WINDIR%\System32\OneDriveSetup.exe"" >nul 2>&1
if exist "%WINDIR%\SysWOW64\OneDriveSetup.exe" "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait cmd /c "del /q /f "%WINDIR%\SysWOW64\OneDriveSetup.exe"" >nul 2>&1
...
Reg add "HKLM\Software\Microsoft\MdmCommon\SettingValues" /v "LocationSyncEnabled" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\FindMyDevice" /v "AllowFindMyDevice" /t REG_DWORD /d 0 /f >nul

REM Disable Action Center
Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\ImmersiveShell" /v "UseActionCenterExperience" /t REG_DWORD /d 0 /f >nul
...
rem Reg add "HKLM\SYSTEM\ControlSet001\Services\wscsvc" /v "Start" /t REG_DWORD /d "4" /f >nul
rem "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait cmd /c "del /q /f "%~dp0mount\Windows\SystemApps\ShellExperienceHost_cw5n1h2txyewy\Windows.UI.ActionCenter.dll"" >nul 2>&1
...
Reg add "HKLM\Software\Policies\Microsoft\MicrosoftEdge\Main" /v "PreventLiveTileDataCollection" /t REG_DWORD /d "1" /f >nul
...
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg delete "HKLM\Software\Microsoft\SystemSettings\SettingId\SystemSettings_AssignedAccess_EdgeAdvancedOptions" /f >nul 2>&1
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg delete "HKLM\Software\Microsoft\SystemSettings\SettingId\SystemSettings_AssignedAccess_EdgeKioskMode" /f >nul 2>&1
reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Config\Microsoft.MicrosoftEdge_8wekyb3d8bbwe" /f >nul 2>&1
if "%ImageArchitecture%"=="x64" reg delete "HKLM\Software\WOW6432Node\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\Config\Microsoft.MicrosoftEdge_8wekyb3d8bbwe" /f >nul 2>&1
reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\InboxApplications\Microsoft.MicrosoftEdge_44.19041.1266.0_neutral__8wekyb3d8bbwe" /f >nul 2>&1
reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\InboxApplications\Microsoft.MicrosoftEdgeDevToolsClient_10.0.19041.1023_neutral__8wekyb3d8bbwe" /f >nul 2>&1
...
if "%ImageArchitecture%"=="x64" Reg delete "HKLM\Software\WOW6432Node\Microsoft\Windows\CurrentVersion\Explorer\Browser Helper Objects\{1FD49718-1D00-4B19-AF5F-070AF6D5D54C}" /f >nul 2>&1
...
Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\WindowsUpdate\OSUpgrade" /v "AllowOSUpgrade" /t REG_DWORD /d "0" /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\DeliveryOptimization" /v "DODownloadMode" /t REG_DWORD /d "99" /f >nul

REM Disable User Account Control
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\System" /v "EnableLUA" /t REG_DWORD /d 0 /f >nul

REM Disable MSHTA and WebView
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Hta" /v "DisableHTMLApplication" /t REG_DWORD /d 1 /f >nul
...
Reg add "HKLM\Software\Microsoft\Windows Defender Security Center\Notifications" /v "DisableNotifications" /t REG_DWORD /d "1" /f >nul
Reg add "HKLM\Software\Microsoft\Windows Defender Security Center\Notifications" /v "DisableEnhancedNotifications" /t REG_DWORD /d "1" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\Software\Microsoft\Windows Defender" /v "DisableAntiSpyware" /t REG_DWORD /d "1" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\Software\Microsoft\Windows Defender" /v "DisableAntiVirus" /t REG_DWORD /d "1" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\Software\Microsoft\Windows Defender\Features" /v "TamperProtectionSource" /t REG_DWORD /d "2" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\Software\Microsoft\Windows Defender\Signature Updates" /v "FirstAuGracePeriod" /t REG_DWORD /d "0" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\Software\Microsoft\Windows Defender\UX Configuration" /v "DisablePrivacyMode" /t REG_DWORD /d "1" /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender" /v "RandomizeScheduleTaskTimes" /t REG_DWORD /d "0" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender" /v "ServiceKeepAlive" /t REG_DWORD /d "0" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Exclusions" /v "DisableAutoExclusions" /t REG_DWORD /d "1" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\MpEngine" /v "MpEnablePus" /t REG_DWORD /d "0" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Quarantine" /v "LocalSettingOverridePurgeItemsAfterDelay" /t REG_DWORD /d "0" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Quarantine" /v "PurgeItemsAfterDelay" /t REG_DWORD /d "0" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Reporting" /v "AdditionalActionTimeOut" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Reporting" /v "CriticalFailureTimeOut" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Reporting" /v "NonCriticalTimeOut" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "AvgCPULoadFactor" /t REG_DWORD /d "10" /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "DisableRestorePoint" /t REG_DWORD /d "1" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "DisableScanningMappedNetworkDrivesForFullScan" /t REG_DWORD /d "1" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "DisableScanningNetworkFiles" /t REG_DWORD /d "1" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "PurgeItemsAfterDelay" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "ScanOnlyIfIdle" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "ScanParameters" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Signature Updates" /v "DisableUpdateOnStartupWithoutEngine" /t REG_DWORD /d 1 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Signature Updates" /v "ForceUpdateFromMU" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\EventLog\System\Microsoft-Antimalware-ShieldProvider" /v "Start" /t REG_DWORD /d "4" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\EventLog\System\WinDefend" /v "Start" /t REG_DWORD /d "4" /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Signature Updates" /v "ScheduleTime" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Signature Updates" /v "SignatureUpdateCatchupInterval" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Real-Time Protection" /v "DisableRoutinelyTakingAction" /t REG_DWORD /d "1" /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Real-Time Protection" /v "DisableScriptScanning" /t REG_DWORD /d "1" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Remediation" /v "Scan_ScheduleDay" /t REG_DWORD /d "8" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Remediation" /v "Scan_ScheduleTime" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "ScheduleDay" /t REG_DWORD /d 8 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Scan" /v "ScheduleTime" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows Defender\Spynet" /v "SpyNetReportingLocation" /t REG_MULTI_SZ /d "0" /f >nul
...
Reg add "HKEY_USERS\.DEFAULT\SOFTWARE\Microsoft\Windows Security Health\State" /v "AccountProtection_MicrosoftAccount_Disconnected" /t REG_DWORD /d "0" /f >nul
...
Reg add "HKEY_USERS\.DEFAULT\SOFTWARE\Microsoft\Windows\CurrentVersion\AppHost" /v "EnableWebContentEvaluation" /t REG_DWORD /d 0 /f >nul
Reg add "HKEY_USERS\.DEFAULT\SOFTWARE\Microsoft\Windows\CurrentVersion\AppHost" /v "PreventOverride" /t REG_DWORD /d 0 /f >nul
Reg add "HKEY_USERS\.DEFAULT\SOFTWARE\Policies\Microsoft\Edge" /v "SmartScreenEnabled" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Microsoft\Windows Security Health\State" /v "AppAndBrowser_StoreAppsSmartScreenOff" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\AppHost" /v "SmartScreenEnabled" /t REG_SZ /d "Off" /f >nul
Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer" /v "SmartScreenEnabled" /t REG_SZ /d "Off" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\PhishingFilter" /v "EnabledV9" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\PhishingFilter" /v "PreventOverride" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\MicrosoftEdge\PhishingFilter" /v "EnabledV9" /t REG_DWORD /d 0 /f >nul
Reg add "HKLM\Software\Policies\Microsoft\MicrosoftEdge\PhishingFilter" /v "PreventOverride" /t REG_DWORD /d 0 /f >nul
...
Reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\0" /v "2301" /t REG_DWORD /d "3" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1" /v "2301" /t REG_DWORD /d "3" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2" /v "2301" /t REG_DWORD /d "3" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3" /v "2301" /t REG_DWORD /d "3" /f >nul
Reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4" /v "2301" /t REG_DWORD /d "3" /f >nul
...
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Main" /v "DisableIEAppNotificationPolicy" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Recovery" /v "AutoRecover" /t REG_DWORD /d 2 /f >nul

reg add "HKLM\Software\Microsoft\Internet Explorer\Main" /v "Start Page" /t REG_SZ /d "about:blank" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\Main" /v "Search Page" /t REG_SZ /d "https://www.google.com/" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\Main" /v "Default_Page_URL" /t REG_SZ /d "about:blank" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\Main" /v "Default_Search_URL" /t REG_SZ /d "https://www.google.com/" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\Main" /v "EnableAutoUpgrade" /t REG_DWORD /d 0 /f >nul


reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Suggested Sites" /v "Enabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer" /v "AllowServicePoweredQSA" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Geolocation" /v "PolicyDisableGeolocation" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Feeds" /v "DisableFeedPane" /t REG_DWORD /d 0 /f >nul
...
reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Explorer\AutoComplete" /v "AutoSuggest" /t REG_SZ /d "no" /f >nul
...
reg delete "HKLM\Software\Microsoft\Internet Explorer\SearchScopes\{0633EE93-D776-472f-A0FF-E1416B8B2E3A}" /f >nul 2>&1

reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes" /v "DefaultScope" /t REG_SZ /d "{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes" /v "DownloadUpdates" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes" /v "Version" /t REG_DWORD /d 4 /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes" /v "ShowSearchSuggestionsInAddressGlobal" /t REG_DWORD /d 0 /f >nul

reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "DisplayName" /t REG_SZ /d "Google" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "URL" /t REG_SZ /d "https://www.google.com/search?q={searchTerms}" /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "ShowSearchSuggestions" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "SuggestionsURL_JSON" /t REG_SZ /d "https://suggestqueries.google.com/complete/search?output=firefox&client=firefox&qu={searchTerms}" /f >nul
reg delete "HKLM\Software\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "FaviconURL" /f >nul 2>&1

reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Restrictions" /v "NoHelpItemSendFeedback" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Restrictions" /v "NoHelpItemNetscapeHelp" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Restrictions" /v "NoHelpItemTipOfTheDay" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Internet Explorer\Restrictions" /v "NoHelpItemTutorial" /t REG_DWORD /d 1 /f >nul

REM Windows Media Player Privacy
reg add "HKLM\Software\Policies\Microsoft\WindowsMediaPlayer" /v "DisableAutoUpdate" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\WindowsMediaPlayer" /v "PreventLibrarySharing" /t REG_DWORD /d 1 /f >nul


REM Disable Metered Connections
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\NetworkList\DefaultMediaCost" /v "3G" /t REG_DWORD /d 1 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\NetworkList\DefaultMediaCost" /v "4G" /t REG_DWORD /d 1 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\NetworkList\DefaultMediaCost" /v "Default" /t REG_DWORD /d 1 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\NetworkList\DefaultMediaCost" /v "Ethernet" /t REG_DWORD /d 1 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\NetworkList\DefaultMediaCost" /v "WiFi" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WwanSvc\NetCost" /v "Cost3G" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\WwanSvc\NetCost" /v "Cost4G" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\Wireless\NetCost" /v "Cost" /t REG_DWORD /d 1 /f >nul
...
Reg add "HKLM\SYSTEM\ControlSet001\Services\TCPIP6\Parameters" /v "EnableICSIPv6" /t REG_DWORD /d "0" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\TCPIP6\Parameters" /v "DisabledComponents" /t REG_DWORD /d "1" /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\TCPIP\v6Transition" /v "6to4_State" /t REG_SZ /d "Disabled" /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\TCPIP\v6Transition" /v "ISATAP_State" /t REG_SZ /d "Disabled" /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\TCPIP\v6Transition" /v "Teredo_State" /t REG_SZ /d "Disabled" /f >nul
set "DisableServices=%DisableServices%,iphlpsvc"

REM Disable Autoshare Disks over LAN network for security
reg add "HKLM\SYSTEM\ControlSet001\Services\lanmanserver\parameters" /v AutoShareWks /t REG_DWORD /d 0 /f >nul

REM Disable IPv4 Autoconfig
Reg add "HKLM\SYSTEM\ControlSet001\Services\Tcpip\Parameters" /v "IPAutoconfigurationEnabled" /t REG_DWORD /d "0" /f >nul

REM Disable IP source routing for security
Reg add "HKLM\SYSTEM\ControlSet001\Services\Tcpip\Parameters" /v "DisableIPSourceRouting" /t REG_DWORD /d "2" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\Tcpip6\Parameters" /v "DisableIPSourceRouting" /t REG_DWORD /d "2" /f >nul

REM Disable Internet Connection Sharing
reg add "HKLM\Software\Microsoft\WcmSvc\Tethering" /v "RemoteStartupDisabled" /t REG_DWORD /d "1" /f >nul
reg add "HKLM\Software\Policies\Microsoft\Windows\Network Connections" /v "NC_ShowSharedAccessUI" /t REG_DWORD /d "0" /f >nul
...
reg add "HKLM\SYSTEM\ControlSet001\services\Dnscache\Parameters" /v "EnableNetbios" /t REG_DWORD /d "0" /f >nul
...
reg add "HKLM\Software\Policies\Microsoft\Peernet" /v "Disabled" /t REG_DWORD /d "1" /f >nul
set "DisableServices=%DisableServices%,PNRPsvc,PNRPAutoReg,p2pimsvc,p2psvc"

REM Disable Mobile Device Manamagment Enrollment
reg add "HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\MDM" /v "DisableRegistration" /t REG_DWORD /d "1" /f >nul
...
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "HonorAutoRunSetting" /t REG_DWORD /d 1 /f >nul
...
if "%DisableCDAutoPlay%"=="0" (
 reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "NoDriveTypeAutoRun" /t REG_DWORD /d 223 /f >nul
...
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\DateTime\Servers" /ve /t REG_SZ /d "0" /f >nul
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\DateTime\Servers" /v "0" /t REG_SZ /d "%NTPserver%" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\W32Time" /v "Start" /t REG_DWORD /d "2" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\W32Time\Parameters" /v "NtpServer" /t REG_SZ /d "%NTPserver%,0x9" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\W32Time\Parameters" /v "Type" /t REG_SZ /d "NTP" /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\W32Time\TimeProviders\NtpClient" /v "Enabled" /t REG_DWORD /d 1 /f >nul
Reg add "HKLM\SYSTEM\ControlSet001\Services\W32Time\TimeProviders\NtpClient" /v "SpecialPollInterval" /t REG_DWORD /d 86400 /f >nul
reg delete "HKLM\SYSTEM\ControlSet001\Services\W32Time\TimeProviders\NtpClient" /v "SpecialPollTimeRemaining" /f >nul 2>&1

REM Disable Time Sync NTP server
reg add "HKLM\Software\Policies\Microsoft\W32time\TimeProviders\NtpServer" /v "Enabled" /t REG_DWORD /d "0" /f >nul

REM Disable Time Sync entirely
if not "%DisableTimeSync%"=="0" (
 reg add "HKLM\Software\Policies\Microsoft\W32time\TimeProviders\NtpClient" /v "Enabled" /t REG_DWORD /d "0" /f >nul
 reg add "HKLM\SYSTEM\ControlSet001\Services\W32Time\Parameters" /v "Type " /t REG_SZ /d "NoSync" /f >nul
...
if not "%DisableSearchService%"=="0" (
 reg delete "HKLM\SYSTEM\ControlSet001\Services\WSearch" /f >nul 2>&1
 reg delete "HKLM\SYSTEM\ControlSet001\Services\WSearchIdxPi" /f >nul 2>&1
...
if not "%DisableSearchIndexing%"=="0" (
 reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "PreventIndexingLowDiskSpaceMB" /t REG_DWORD /d 0x7fffffff /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "PreventIndexOnBattery" /t REG_DWORD /d 1 /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "PreventIndexingEmailAttachments" /t REG_DWORD /d 1 /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "PreventIndexingOfflineFiles" /t REG_DWORD /d 1 /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "PreventIndexingOutlook" /t REG_DWORD /d 1 /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "PreventIndexingPublicFolders" /t REG_DWORD /d 1 /f >nul
)
...
reg add "HKEY_USERS\.DEFAULT\Control Panel\Desktop" /v "UserPreferencesMask" /t REG_BINARY /d 9012078010000000 /f >nul
reg add "HKEY_USERS\.DEFAULT\Control Panel\Desktop\WindowMetrics" /v "MinAnimate" /t REG_SZ /d "0" /f >nul
...
if not "%DisablePrefetcher%"=="0" (
 reg add "HKLM\SYSTEM\ControlSet001\Control\Session Manager\Memory Management\PrefetchParameters" /f /v EnableSuperfetch /t REG_DWORD /d 0 >nul
 reg add "HKLM\SYSTEM\ControlSet001\Control\Session Manager\Memory Management\PrefetchParameters" /f /v EnablePrefetcher /t REG_DWORD /d 0 >nul
...
if "%ImageArchitecture%"=="x64" reg add "HKLM\Software\Wow6432Node\Microsoft\Windows NT\CurrentVersion\AeDebug" /v "Auto" /t REG_SZ /d "0" /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Control\CrashControl" /v CrashDumpEnabled /t REG_DWORD /d 0 /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Control\CrashControl" /v LogEvent /t REG_DWORD /d 0 /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Control\CrashControl" /v EnableLogFile /t REG_DWORD /d 0 /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Control\Session Manager" /v AutoChkTimeOut /t REG_DWORD /d 1 /f >nul
...
reg add "HKLM\SYSTEM\ControlSet001\Control\Power" /v HibernateEnabled /t REG_DWORD /d 0 /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Control\Power" /v HibernateEnabledDefault /t REG_DWORD /d 0 /f >nul

REM Disable Screen Off timer for Balanced and High Performance power schemes, when PC is connected to power source
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\381b4222-f694-41f0-9685-ff5bb260df2e\7516b95f-f776-4464-8c53-06167f40cc99\3c0bc021-c8a8-4e07-a973-6b14cbcb2b7e" /v ACSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c\7516b95f-f776-4464-8c53-06167f40cc99\3c0bc021-c8a8-4e07-a973-6b14cbcb2b7e" /v ACSettingIndex /t REG_DWORD /d 0 /f >nul

REM Disable USB AutoSuspend for Balanced and High Performance power schemes
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\381b4222-f694-41f0-9685-ff5bb260df2e\2a737441-1930-4402-8d77-b2bebba308a3\48e6b7a6-50f5-4782-a5d4-53bb8f07e226" /v ACSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\381b4222-f694-41f0-9685-ff5bb260df2e\2a737441-1930-4402-8d77-b2bebba308a3\48e6b7a6-50f5-4782-a5d4-53bb8f07e226" /v DCSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c\2a737441-1930-4402-8d77-b2bebba308a3\48e6b7a6-50f5-4782-a5d4-53bb8f07e226" /v ACSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c\2a737441-1930-4402-8d77-b2bebba308a3\48e6b7a6-50f5-4782-a5d4-53bb8f07e226" /v DCSettingIndex /t REG_DWORD /d 0 /f >nul

REM Disable idle Hard Disk auto power off for Balanced and High Performance power schemes
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\381b4222-f694-41f0-9685-ff5bb260df2e\0012ee47-9041-4b5d-9b77-535fba8b1442\6738e2c4-e8a5-4a42-b16a-e040e769756e" /v ACSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\381b4222-f694-41f0-9685-ff5bb260df2e\0012ee47-9041-4b5d-9b77-535fba8b1442\6738e2c4-e8a5-4a42-b16a-e040e769756e" /v DCSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c\0012ee47-9041-4b5d-9b77-535fba8b1442\6738e2c4-e8a5-4a42-b16a-e040e769756e" /v ACSettingIndex /t REG_DWORD /d 0 /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\Power\User\PowerSchemes\8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c\0012ee47-9041-4b5d-9b77-535fba8b1442\6738e2c4-e8a5-4a42-b16a-e040e769756e" /v DCSettingIndex /t REG_DWORD /d 0 /f >nul


REM Disable loggers
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\SYSTEM\ControlSet001\Control\Diagnostics\Performance" /v "DisableDiagnosticTracing" /t REG_DWORD /d "1" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\SYSTEM\ControlSet001\Control\Diagnostics\Performance\BootCKCLSettings" /v "Start" /t REG_DWORD /d "0" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\SYSTEM\ControlSet001\Control\Diagnostics\Performance\SecondaryLogonCKCLSettings" /v "Start" /t REG_DWORD /d "0" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\SYSTEM\ControlSet001\Control\Diagnostics\Performance\ShutdownCKCLSettings" /v "Start" /t REG_DWORD /d "0" /f >nul
...
reg add "HKLM\Software\Microsoft\WBEM\CIMOM" /v "Logging" /t REG_DWORD /d 0 /f >nul

REM Disable CBS logging
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Component Based Servicing" /v "EnableLog" /t REG_DWORD /d "0" /f >nul
...
reg add "HKLM\SYSTEM\ControlSet001\Services\sppsvc" /v "Start" /t REG_DWORD /d "3" /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Services\EventLog\Application\Software Protection Platform Service" /v "Start" /t REG_DWORD /d "4" /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Services\EventLog\Application\Microsoft-Windows-Security-SPP" /v "Start" /t REG_DWORD /d "4" /f >nul
reg add "HKLM\SYSTEM\ControlSet001\Control\WMI\Autologger\EventLog-Application\{e23b33b0-c8c9-472c-a5f9-f2bdfea0f156}" /v "Enabled" /t REG_DWORD /d "0" /f >nul
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-Security-SPP-UX-GenuineCenter-Logging/Operational" /v "Enabled" /t REG_DWORD /d 0 /f >nul
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-Security-SPP-UX-Notifications/ActionCenter" /v "Enabled" /t REG_DWORD /d 0 /f >nul
...
for %%t in (%DisableTrackers%) do (
 for /f "tokens=1 delims=" %%a in ('reg query "HKLM\SYSTEM\ControlSet001\Control\WMI\Autologger" /e /k /f "%%~t" 2^>nul ^| find /i "%%~t"') do (
    ECHO Disabling tracker %%~t
    "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Control\WMI\Autologger\%%~t" /v "Start" /t REG_DWORD /d "0" /f >nul
  )
)
...
for %%s in (%DisableServices%) do (
 for /f "tokens=1 delims=" %%a in ('reg query "HKLM\SYSTEM\ControlSet001\Services" /e /k /f "%%s" 2^>nul ^| find /i "%%s"') do (
    ECHO Disabling service %%s
    "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\SYSTEM\ControlSet001\Services\%%s" /v "Start" /t REG_DWORD /d "4" /f >nul
  )
)
...
for %%t in (%RemoveTasks%) do (
 for /f "tokens=3 delims= " %%a in ('reg query "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tree\Microsoft\Windows\%%~t" /v "Id" 2^>nul ^| find /i "Id" ^| find /i "REG_SZ"') do (
  ECHO Removing task %%~t
  "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tree\Microsoft\Windows\%%~t" /f >nul 2>&1
  "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Maintenance\%%a" /f >nul 2>&1
  "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Plain\%%a" /f >nul 2>&1
  "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tasks\%%a" /f >nul 2>&1
 )
)
...
for %%p in (%DisableSysUWPpermissions%) do (
 for /f "tokens=1 delims=" %%a in ('reg query "HKLM\Software\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\Capabilities" /e /k /f "%%p" 2^>nul ^| find /i "%%p"') do (
    for /f "tokens=1 delims=" %%b in ('reg query "HKLM\Software\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\Capabilities\%%p\Apps" 2^>nul ^| find "\Apps\"') do (
      echo.
      echo Removing registry key
      echo %%b
     "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait Reg delete "%%b" /f >nul 2>&1
    )
  )
)
...
for %%p in (%DisableUWPpermissions%) do (
 ...
 reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\%%p" /v "Value" /t REG_SZ /d "Deny" /f >nul
...
for %%u in (%RemoveSystemUWPapps%) do (
 ...
 for /f "tokens=1 delims=" %%a in ('reg query "HKLM\Software\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore" /s /f "%%u" /k 2^>nul ^| find /i "HKEY_LOCAL_MACHINE\TK_SOFTWARE\"') do (
...
for %%u in (%RemoveSystemUWPapps%) do (
 for /f "tokens=1 delims=" %%a in ('dir /b /ad "%WINDIR%\SystemApps" 2^>nul ^| find /i "%%u"') do (
    ECHO Removing %%a from Disk
    "NSudoLC" -U:T -P:E -UseCurrentConsole -Wait cmd /c "rd /s /q "%WINDIR%\SystemApps\%%a""
  )
)
...
if not "%DisableInternetConnectionChecking%"=="0" (
 reg add "HKLM\SYSTEM\ControlSet001\Services\NlaSvc\Parameters\Internet" /v "EnableActiveProbing" /t REG_DWORD /d 0 /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\NetworkConnectivityStatusIndicator" /v "NoActiveProbe" /t REG_DWORD /d 1 /f >nul
 reg add "HKLM\Software\Policies\Microsoft\Windows\Network Connections" /v "NC_DoNotShowLocalOnlyIcon" /t REG_DWORD /d 1 /f >nul
)
...
if "%ImageArchitecture%"=="x64" (
 reg delete "HKLM\Software\Wow6432Node\Microsoft\Windows NT\CurrentVersion\drivers.desc" /v "X:\Windows\SysWOW64\l3codeca.acm" /f >nul 2>&1
 reg add "HKLM\Software\Wow6432Node\Microsoft\Windows NT\CurrentVersion\drivers.desc" /v "X:\Windows\SysWOW64\l3codecp.acm" /t REG_SZ /d "Fraunhofer IIS MPEG Audio Layer-3 Codec (professional)" /f >nul
 reg add "HKLM\Software\Wow6432Node\Microsoft\Windows NT\CurrentVersion\Drivers32" /v "msacm.l3acm" /t REG_SZ /d "X:\Windows\SysWOW64\l3codecp.acm" /f >nul
)

reg delete "HKLM\Software\Microsoft\Windows NT\CurrentVersion\drivers.desc" /v "X:\Windows\System32\l3codeca.acm" /f >nul 2>&1
reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\drivers.desc" /v "X:\Windows\System32\l3codecp.acm" /t REG_SZ /d "Fraunhofer IIS MPEG Audio Layer-3 Codec (professional)" /f >nul
reg add "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Drivers32" /v "msacm.l3acm" /t REG_SZ /d "X:\Windows\System32\l3codecp.acm" /f >nul


REM Enable WMP11 WebMedia support
reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM" /v "FriendlyTypeName" /t REG_EXPAND_SZ /d "@%%SystemRoot%%\system32\unregmp2.exe,-9905" /f >nul
reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\DefaultIcon" /ve /t REG_EXPAND_SZ /d "%%SystemRoot%%\system32\wmploc.dll,-731" /f >nul
reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell" /ve /t REG_SZ /d "Play" /f >nul
reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell\play" /ve /t REG_SZ /d "&Play" /f >nul
reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell\play" /v MUIVerb /t REG_EXPAND_SZ /d "@%%SystemRoot%%\system32\unregmp2.exe,-9991" /f >nul
if "%ImageArchitecture%"=="x86" (
 reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell\play\command" /ve /t REG_EXPAND_SZ /d "\"%%ProgramFiles%%\Windows Media Player\wmplayer.exe\" /prefetch:6 /Play \"%%L\"" /f >nul
 reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell\open\command" /ve /t REG_EXPAND_SZ /d "\"%%ProgramFiles%%\Windows Media Player\wmplayer.exe\" /prefetch:6 /Open \"%%L\"" /f >nul
)
if not "%ImageArchitecture%"=="x64" goto skipWebMx64
 reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell\play\command" /ve /t REG_EXPAND_SZ /d "\"%%ProgramFiles(x86)%%\Windows Media Player\wmplayer.exe\" /prefetch:6 /Play \"%%L\"" /f >nul
 reg add "HKLM\Software\Classes\WMP11.AssocFile.WebM\shell\open\command" /ve /t REG_EXPAND_SZ /d "\"%%ProgramFiles(x86)%%\Windows Media Player\wmplayer.exe\" /prefetch:6 /Open \"%%L\"" /f >nul
:skipWebMx64
reg add "HKLM\Software\Microsoft\Windows Photo Viewer\Capabilities\FileAssociations" /v ".webm" /t REG_SZ /d "WMP11.AssocFile.WebM" /f >nul
...
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.HEIF" /v "FriendlyTypeName" /t REG_EXPAND_SZ /d "@%%ProgramFiles%%\Windows Photo Viewer\PhotoViewer.dll,-3057" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.HEIF" /v "ImageOptionFlags" /t REG_DWORD /d "1" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.HEIF\DefaultIcon" /ve /t REG_SZ /d "%%SystemRoot%%\System32\imageres.dll,-71" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.HEIF\shell\open\command" /ve /t REG_EXPAND_SZ /d "%%SystemRoot%%\System32\rundll32.exe \"%%ProgramFiles%%\Windows Photo Viewer\PhotoViewer.dll\", ImageView_Fullscreen %%1" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.HEIF\shell\open\DropTarget" /v "Clsid" /t REG_SZ /d "{FFE2A43C-56B9-4bf5-9A79-CC6D4285608A}" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.WebP" /v "FriendlyTypeName" /t REG_EXPAND_SZ /d "@%%ProgramFiles%%\Windows Photo Viewer\PhotoViewer.dll,-3057" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.WebP" /v "ImageOptionFlags" /t REG_DWORD /d "1" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.WebP\DefaultIcon" /ve /t REG_SZ /d "%%SystemRoot%%\System32\imageres.dll,-71" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.WebP\shell\open\command" /ve /t REG_EXPAND_SZ /d "%%SystemRoot%%\System32\rundll32.exe \"%%ProgramFiles%%\Windows Photo Viewer\PhotoViewer.dll\", ImageView_Fullscreen %%1" /f >nul
reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.WebP\shell\open\DropTarget" /v "Clsid" /t REG_SZ /d "{FFE2A43C-56B9-4bf5-9A79-CC6D4285608A}" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.Tiff" /v "FriendlyTypeName" /t REG_EXPAND_SZ /d "@%%ProgramFiles%%\Windows Photo Viewer\PhotoViewer.dll,-3058" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.Tiff" /v "ImageOptionFlags" /t REG_DWORD /d "1" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.Tiff\DefaultIcon" /ve /t REG_SZ /d "%%SystemRoot%%\System32\imageres.dll,-122" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.Tiff\shell\open" /v "MuiVerb" /t REG_EXPAND_SZ /d "@%%ProgramFiles%%\Windows Photo Viewer\photoviewer.dll,-3043" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.Tiff\shell\open\command" /ve /t REG_EXPAND_SZ /d "%%SystemRoot%%\System32\rundll32.exe \"%%ProgramFiles%%\Windows Photo Viewer\PhotoViewer.dll\", ImageView_Fullscreen %%1" /f >nul
"NSudoLC" -U:T -P:E -UseCurrentConsole -Wait reg add "HKLM\Software\Classes\PhotoViewer.FileAssoc.Tiff\shell\open\DropTarget" /v "Clsid" /t REG_SZ /d "{FFE2A43C-56B9-4bf5-9A79-CC6D4285608A}" /f >nul
...
reg add "HKLM\Software\Microsoft\Windows Photo Viewer\Capabilities\FileAssociations" /v ".heif" /t REG_SZ /d "PhotoViewer.FileAssoc.HEIF" /f >nul
reg add "HKLM\Software\Microsoft\Windows Photo Viewer\Capabilities\FileAssociations" /v ".webp" /t REG_SZ /d "PhotoViewer.FileAssoc.WebP" /f >nul
...
reg add "HKLM\Software\RegisteredApplications" /v "Windows Calculator" /t REG_SZ /d "SOFTWARE\Microsoft\Windows\CurrentVersion\Applets\Calculator\Capabilities" /f >nul
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Applets\Calculator\Capabilities" /v "ApplicationName" /t REG_EXPAND_SZ /d "@%%SystemRoot%%\system32\win32calc.exe" /f >nul
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Applets\Calculator\Capabilities" /v "ApplicationDescription" /t REG_EXPAND_SZ /d "@%%SystemRoot%%\system32\win32calc.exe,-217" /f >nul
reg add "HKLM\Software\Microsoft\Windows\CurrentVersion\Applets\Calculator\Capabilities\URLAssociations" /v "calculator" /t REG_SZ /d "calculator" /f >nul

reg add "HKLM\Software\Classes\.hlp" /ve /t REG_SZ /d "hlpfile" /f >nul
reg add "HKLM\Software\Classes\hlpfile" /ve /t REG_SZ /d "Help File" /f >nul
reg add "HKLM\Software\Classes\hlpfile" /v "FriendlyTypeName" /t REG_SZ /d "@shell32.dll,-10145" /f >nul
reg add "HKLM\Software\Classes\hlpfile\DefaultIcon" /ve /t REG_EXPAND_SZ /d "%%SystemRoot%%\System32\shell32.dll,23" /f >nul
reg add "HKLM\Software\Classes\hlpfile\shell\open\command" /ve /t REG_EXPAND_SZ /d "%%SystemRoot%%\winhlp32.exe %%1" /f >nul
