...
reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\BackgroundModel\BackgroundAudioPolicy" /v "InactivityTimeoutMs" /t REG_DWORD /d "FFFFFFFF" /f
...
powershell -nop -ep bypass -c "Disable-MMAgent -MemoryCompression -PageCombining"
powershell -nop -ep bypass -c "Enable-MMAgent -ApplicationPreLaunch"
...
powershell -nop -ep bypass -c "Set-NetOffloadGlobalSetting -ReceiveSegmentCoalescing Disabled -PacketCoalescingFilter Disabled -Chimney Disabled -ReceiveSideScaling Enabled -TaskOffload Enabled -ScalingHeuristics Disabled"
powershell -nop -ep bypass -c "Set-NetTCPSetting -SettingName '*' -InitialCongestionWindow 10 -MinRto 300"
...
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *FlowControl -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *InterruptModeration -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword ULPMode -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword ITR -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *LsoV2IPv4 -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *LsoV2IPv6 -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *PriorityVLANTag -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword AdaptiveIFS -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *IPChecksumOffloadIPv4 -RegistryValue 3"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *TCPChecksumOffloadIPv4 -RegistryValue 3"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *TCPChecksumOffloadIPv6 -RegistryValue 3"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *UDPChecksumOffloadIPv4 -RegistryValue 3"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *UDPChecksumOffloadIPv6 -RegistryValue 3"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *PMARPOffload -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *PMNSOffload -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *RSS -RegistryValue 1"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *NumRssQueues -RegistryValue 2"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *WakeOnMagicPacket -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *WakeOnPattern -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword EEELinkAdvertisement -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword EnablePME -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword ReduceSpeedOnPowerDown -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword EnableWakeOnManagmentOnTCO -RegistryValue 0"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword LogLinkStateEvent -RegistryValue 16"
powershell -nop -ep bypass -c "Set-NetAdapterAdvancedProperty -Name '*' -RegistryKeyword *JumboPacket -RegistryValue 1514"
powershell -nop -ep bypass -c "Set-NetAdapterRss -Name '*' -BaseProcessorNumber 2"
powershell -nop -ep bypass -c "Set-NetAdapterRss -Name '*' -MaxProcessorNumber 2"
...
powershell -nop -ep bypass -c "Set-SmbServerConfiguration -EnableSMB1Protocol $false -Force"
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" /v "BranchReadinessLevel" /t REG_DWORD /d "14" /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" /v "DeferFeatureUpdatesPeriodInDays" /t REG_DWORD /d 16d /f
...
del /S /Q "C:\Users\%%a\Desktop\edge.lnk" 
del /S /Q "C:\Users\%%a\Desktop\Microsoft Edge.lnk" )
