@echo off & title EdgeChromium : Onedrive  : Features : Capabilities : MetroApps ^& SystemApps Tweaker & color 17
cd /d "%~dp0"
echo ======================================================
...
install_wim_tweak_NET4.6.exe /o /c Microsoft-Windows-OneDrive /r
echo.
