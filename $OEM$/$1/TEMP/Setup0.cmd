...
:: powershell -noprofile -executionpolicy bypass -command "Get-ChildItem HKLM:\SOFTWARE -Rec -ea 0|Where-Object{$_.Name -Match 'edge' -and $_.Name -NotMatch 'EdgeGesture'}|Remove-Item -Rec"
