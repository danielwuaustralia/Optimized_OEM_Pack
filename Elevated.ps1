...
Get-ChildItem -Path 'HKLM:\SYSTEM\CurrentControlSet\Services' | Where-Object -Property Name -Like *Credential Manager* | Set-ItemProperty -Name Start -Value 3 -Force
